...
class C_delivery extends CI_Controller {
    ...
    function c_save(){
        ...
        $getuser_random = " SELECT user_name FROM whs_m_users where user_name<>'".$this->session->userdata('autogate_username')."' ORDER BY RAND() " ;
    ...
    function c_formedit(){
        ...
        // );
        // $txtNoDo = ComboDb($createcombo);
        $arraydata = array('bl_no' => $do_no,'bl_no1' => $do_no);
