...
class C_CekDataTerkirim extends CI_Controller {
    ...
    function c_sinkron_to_gateinfcl(){
        ...
        $hasil = $this->db_tpsonline->update('tbl_request_plp_in_container', array('VALIDATE' => 'Y'));

        $this->db_tpsonline->where_in('REF_NUMBER',$data_container);
        $this->db_tpsonline->where(array('VALIDATE' => 'N'));
        $hasil1 = $this->db_tpsonline->update('tbl_request_plp_out_container', array('VALIDATE' => 'Y'));
    ...
    function c_sinkron_to_gateinlcl(){
        ...
        $this->db_tpsonline->where(array('VALIDATE' => 'N'));
        $hasil = $this->db_tpsonline->update('tbl_request_plp_in_kemasan', array('VALIDATE' => 'Y'));

        $this->db_tpsonline->where_in('REF_NUMBER',$data_kemasan);
        $this->db_tpsonline->where(array('VALIDATE' => 'N'));
        $hasil1 = $this->db_tpsonline->update('tbl_request_plp_out_kemasan', array('VALIDATE' => 'Y'));
